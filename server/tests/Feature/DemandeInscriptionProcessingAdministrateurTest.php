...
class DemandeInscriptionProcessingAdministrateurTest extends TestCase
{
    ...
    public function it_can_reject_demande()
    {
        ...
        $response = $this->actingAs($this->user)->postJson("/api/admin/admin/reject-demande/$id");
        // dd('1');
    ...
    public function it_returns_404_if_demande_not_found()
    {
        ...
        $response = $this->actingAs($this->user)->postJson('/api/admin/admin/reject-demande/', ['idDemande' => 999]);
