<template>
    <div class="max-w-screen-xl" style="margin-top: 10px;" v-if="user">
     ...
     <div class="flex-col">
        ...
        <div
            class="xl:w-[80%] lg:w-[90%] md:w-[90%] sm:w-[92%] xs:w-[90%] mx-auto flex flex-col gap-4 items-center relative lg:-top-8 md:-top-6 sm:-top-4 xs:-top-4" style="margin-top: 50px">
                    ...
                    <div class="w-full">
                        <dl class="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            ...
                            <div class="flex flex-col py-3">
                                ...
                                <dd class="text-lg font-semibold">{{user.nom}}</dd>
                            </div>
                    ...
                    <div class="w-full">
                        <dl class="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            <div class="flex flex-col pb-3">
                                ...
                                <dd class="text-lg font-semibold">ENSA TANGER, Maroc</dd>
                            </div>
            ...
            <div
                ...
                <a href="https://www.linkedin.com/in/malak-el-bakali/">
