...
<div class="flex flex-wrap items-center justify-between">
    ...
    <button onclick="openModal('modelConfirm')" href="#" class="block pb-1 mt-2 text-base font-black text-black uppercase border-b border-transparent custom-hover-text" style="margin-right: 30px;">
        Ajouter offre ->
    </button>
</div>

<div class="max-w-screen-xl" style="margin-top: 20px;">
    <div class="bg-white shadow-lg p-6 rounded-lg">
        <div class="flex justify-between">
            <h1 class="text-2xl font-bold">Offre Inventeurs du Futur</h1>
            <span class="block bg-white rounded-full text-black text-xs font-bold px-3 py-2 leading-none flex items-center">
                <button onclick="openModal('sure')">
                ...
                <button onclick="openModal('modifier')" style="margin-left: 8px;">
                    <svg width="15px" height="15px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 121.96" style="enable-background:new 0 0 122.88 121.96" xml:space="preserve">
                        <g>
        ...
        <div style="margin-bottom: 8px">Plongez vos enfants dans une aventure technologique complète avec notre atelier "Inventeurs du Futur" ! Nous combinons la programmation, la robotique et les échecs pour développer leurs compétences techniques tout en stimulant leur créativité et leur esprit stratégique.</div>
        <div class="sm:grid lg:grid-cols-3 sm:grid-cols-2 gap-10">
            <div class="custom-hover-bg hover:text-white transition duration-300 max-w-sm rounded overflow-hidden shadow-lg">
                <div class="py-4 px-8">
                    <a href="#">
...
<div id="modifier" class="fixed hidden inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4">
    <modifierOffre/>
</div>

<div id="sure" class="fixed hidden z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4">
    <supprimerOffre/>
</div>
<div id="listeEA" class="fixed hidden inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4">
    <listeEA />
</div>
