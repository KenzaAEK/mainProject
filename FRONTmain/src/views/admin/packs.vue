<template>
    <div class="flex flex-wrap items-center justify-between ">
            ...
            <button onclick="openModal('pack')" href="#" class="block pb-1 mt-2 text-base font-black text-black uppercase border-b border-transparent custom-hover-text " >
                Ajouter Remise ->
            </button>
        </div>
    ...
    <thead>
        <tr>
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nom remise</th>
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Taux de reducton</th>
    ...
    <div id="pack" class="fixed hidden z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4">
    <ajouterPacks />
</div>
<div id="modifier" class="fixed hidden z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4">
    <modifierPack />
</div>
